...
.PHONY: help validate test lifecycle-test multi-product-test preflight bootstrap render status verify observe grafana portal demo metered-demo showcase reset-demo uninstall
